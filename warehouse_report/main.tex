...
To support the theoretical analysis and provide a practical implementation framework, a comprehensive Python simulation tool has been developed. The implementation encompasses all analytical methods described in this report, including FOSM, Monte Carlo simulation, and FORM analysis \cite{mckinney2010, oliphant2007}. The code is structured into modular components for clarity and maintainability, following software engineering best practices for scientific computing \cite{wilson2014}.
...
\item \textbf{Random Variable Generation:} Implements efficient sampling from normal and lognormal distributions using NumPy's vectorized operations \cite{oliphant2007}, with parameter transformations for lognormal variables.
...
\item \textbf{Visualization Suite:} Produces publication-quality figures (300 DPI) using Matplotlib and Seaborn \cite{hunter2007, waskom2021}.
\end{itemize}
...
\bibitem{wilson2014}
Wilson, G., Aruliah, D. A., Brown, C. T., Chue Hong, N. P., Davis, M., Guy, R. T., ... \& Wilson, P. (2014). Best practices for scientific computing. \textit{PLOS Biology}, 12(1), e1001745.

\bibitem{melchers1999}
Melchers, R. E. (1999). \textit{Structural Reliability Analysis and Prediction} (2nd ed.). John Wiley \& Sons.

\bibitem{phoon1999}
Phoon, K. K., \& Kulhawy, F. H. (1999). Characterization of geotechnical variability. \textit{Canadian Geotechnical Journal}, 36(4), 612--624.
