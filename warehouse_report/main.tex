...
\begin{abstract}
This report applies uncertainty quantification and reliability analysis methods to assess warehouse order picking performance under stochastic conditions. Using FOSM, Monte Carlo simulation (100,000 samples), and FORM, the analysis quantifies the probability of exceeding a 20-minute Service Level Agreement threshold. Results indicate a failure probability of approximately 7.3\%, with order size and picking time per line identified as the dominant sources of uncertainty through sensitivity analysis.
\end{abstract}

\vspace{1cm}
\noindent\textbf{Keywords:} Uncertainty Quantification, Reliability Analysis, Warehouse Operations, Monte Carlo Simulation, FORM, Service Level Agreement
